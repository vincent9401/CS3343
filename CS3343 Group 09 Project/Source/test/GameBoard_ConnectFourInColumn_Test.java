...
public class GameBoard_ConnectFourInColumn_Test {
	...
	@Test
	public void testConnectedInColumnV1() {
	...
	@Test
	public void testConnectedInColumnV2() {
		GameBoard gameBoard = this._gameBoard;
		GameScreenOutputController outputController = this._outputController;
		gameBoard.initializeGameBoard();
	...
	@Test
	public void testConnectedInColumnV3() {
		GameBoard gameBoard = this._gameBoard;
		GameScreenOutputController outputController = this._outputController;
		gameBoard.initializeGameBoard();
	...
	@Test
	public void testConnectedInColumnV4() {
		GameBoard gameBoard = this._gameBoard;
		GameScreenOutputController outputController = this._outputController;
		gameBoard.initializeGameBoard();
	...
	@Test
	public void testConnectedInColumnV5() {
		GameBoard gameBoard = this._gameBoard;
		GameScreenOutputController outputController = this._outputController;
		gameBoard.initializeGameBoard();
