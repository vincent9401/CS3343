...
public class AlphaGo_WinByOneAction_Test {
	...
	@Test
	public void testAlphaGoWinByOneActionV1() {
	...
	@Test
	public void testAlphaGoWinByOneActionV2() throws CloneNotSupportedException {
		GameBoard gameBoard = this._gameBoard;
		gameBoard.initializeGameBoard();
	...
	@Test
	public void testAlphaGoWinByOneActionV3() throws CloneNotSupportedException {
		GameBoard gameBoard = this._gameBoard;
		gameBoard.initializeGameBoard();
	...
	@Test
	public void testAlphaGoWinByOneActionV4() throws CloneNotSupportedException {
		GameBoard gameBoard = this._gameBoard;
		gameBoard.initializeGameBoard();
		gameBoard.putTokenIntoGameBoard("A", true);
		gameBoard.putTokenIntoGameBoard("B", true);
	...
	@Test
	public void testAlphaGoWinByOneActionV5() throws CloneNotSupportedException {
		GameBoard gameBoard = this._gameBoard;
		gameBoard.initializeGameBoard();
		gameBoard.putTokenIntoGameBoard("A", true);
		gameBoard.putTokenIntoGameBoard("B", true);
